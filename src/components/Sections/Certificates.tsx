...
const Certificates: FC = memo(() => {
  ...
  return (
    <Section noPadding sectionId={SectionId.Certificates}>
      <div
...
const Testimonial: FC<{testimonial: Testimonial; isActive: boolean}> = memo(
  ({testimonial: {text, name, image}, isActive}) => (
    <div
      className={classNames(
        'flex w-full shrink-0 snap-start snap-always flex-col items-start gap-y-4 p-2 transition-opacity duration-1000 sm:flex-row sm:gap-x-6 items-center justify-center',
      ...
      <div className="flex flex-col gap-y-4">
        ...
        <img className="h-48 w-full object-contain border-8" src={image} />
